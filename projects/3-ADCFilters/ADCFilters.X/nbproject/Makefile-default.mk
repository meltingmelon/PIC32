...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Lab3Application.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=../../../src/BOARD.c ../../../src/NonVolatileMemory.c ../../../src/delays.c ../../../src/ADCFilter.c lab3Application.c ../../../src/FreeRunningTimer.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1386528437/BOARD.o ${OBJECTDIR}/_ext/1386528437/NonVolatileMemory.o ${OBJECTDIR}/_ext/1386528437/delays.o ${OBJECTDIR}/_ext/1386528437/ADCFilter.o ${OBJECTDIR}/lab3Application.o ${OBJECTDIR}/_ext/1386528437/FreeRunningTimer.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1386528437/BOARD.o.d ${OBJECTDIR}/_ext/1386528437/NonVolatileMemory.o.d ${OBJECTDIR}/_ext/1386528437/delays.o.d ${OBJECTDIR}/_ext/1386528437/ADCFilter.o.d ${OBJECTDIR}/lab3Application.o.d ${OBJECTDIR}/_ext/1386528437/FreeRunningTimer.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1386528437/BOARD.o ${OBJECTDIR}/_ext/1386528437/NonVolatileMemory.o ${OBJECTDIR}/_ext/1386528437/delays.o ${OBJECTDIR}/_ext/1386528437/ADCFilter.o ${OBJECTDIR}/lab3Application.o ${OBJECTDIR}/_ext/1386528437/FreeRunningTimer.o

# Source Files
SOURCEFILES=../../../src/BOARD.c ../../../src/NonVolatileMemory.c ../../../src/delays.c ../../../src/ADCFilter.c lab3Application.c ../../../src/FreeRunningTimer.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Lab3Application.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/lab3Application.o: lab3Application.c  .generated_files/a6bc35f35994fdb4d1d1120b9a363be1d1b7df44.flag .generated_files/71b2fa7f85a22426d8b136d9a94b6b5776fdc3b0.flag
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/lab3Application.o.d 
	@${RM} ${OBJECTDIR}/lab3Application.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -I"../../../include" -I"../../../src" -MP -MMD -MF "${OBJECTDIR}/lab3Application.o.d" -o ${OBJECTDIR}/lab3Application.o lab3Application.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
...
${OBJECTDIR}/lab3Application.o: lab3Application.c  .generated_files/47de10ea3259fc2777ab7128522a46ec6e2dd568.flag .generated_files/71b2fa7f85a22426d8b136d9a94b6b5776fdc3b0.flag
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/lab3Application.o.d 
	@${RM} ${OBJECTDIR}/lab3Application.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -I"../../../include" -I"../../../src" -MP -MMD -MF "${OBJECTDIR}/lab3Application.o.d" -o ${OBJECTDIR}/lab3Application.o lab3Application.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Lab3Application.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  ../../../src/Protocol.X.a ../../../src/FrequencyGenerator.X.a  
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -g -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Lab3Application.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}    ../../../src/Protocol.X.a ../../../src/FrequencyGenerator.X.a      -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)   -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC02000:0x1FC02FEF -mreserve=boot@0x1FC02000:0x1FC024FF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D=__DEBUG_D,--defsym=__MPLAB_DEBUGGER_PK3=1,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -mdfp="${DFP_DIR}"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Lab3Application.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  ../../../src/Protocol.X.a ../../../src/FrequencyGenerator.X.a 
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Lab3Application.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}    ../../../src/Protocol.X.a ../../../src/FrequencyGenerator.X.a      -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -mdfp="${DFP_DIR}"
	${MP_CC_DIR}/xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/Lab3Application.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
